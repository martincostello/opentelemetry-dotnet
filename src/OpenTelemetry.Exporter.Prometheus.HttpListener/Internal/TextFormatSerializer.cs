...
internal abstract class TextFormatSerializer
{
    ...
    public static TextFormatSerializer GetSerializer(PrometheusProtocol protocol)
    {
...
internal class PrometheusTextV0Serializer : PrometheusTextSerializer
{
}

internal class PrometheusTextV1Serializer : PrometheusTextSerializer
{
}
...
internal class OpenMetricsV0Serializer : OpenMetricsSerializer
{
}

internal class OpenMetricsV1Serializer : OpenMetricsSerializer
{
}
