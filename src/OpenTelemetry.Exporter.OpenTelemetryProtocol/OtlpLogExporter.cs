...
public sealed class OtlpLogExporter : BaseExporter<LogRecord>
{
    ...
    public OtlpLogExporter(IOptionsMonitor<OtlpExporterOptions> optionsMonitor)
...
#pragma warning restore CS0618 // Suppressing gRPC obsolete warning
        this.transmissionHandler = transmissionHandler ?? optionsMonitor!.GetExportTransmissionHandler(experimentalOptions!, OtlpSignalType.Logs);
    }
